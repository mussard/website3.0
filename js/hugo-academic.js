...
(function($){
  ...
  let $grid_talks = $('#container-talks');
  $grid_talks.imagesLoaded(function () {
    // Initialize Isotope after all images have loaded.
    $grid_talks.isotope({
      itemSelector: '.isotope-item',
      layoutMode: 'vertical'
    ...
    $('#filters a').click(function () {
      let selector = $(this).attr('data-filter');
      $grid_talks.isotope({filter: selector});
      $(this).removeClass('active').addClass('active').siblings().removeClass('active all');
      return false;
    });
  });
  ...
  let $grid_softwares = $('#container-softwares');
  $grid_softwares.imagesLoaded(function () {
    // Initialize Isotope after all images have loaded.
    $grid_softwares.isotope({
      itemSelector: '.isotope-item',
      layoutMode: 'vertical'
    });
    ...
    $('#filters a').click(function () {
      let selector = $(this).attr('data-filter');
      $grid_softwares.isotope({filter: selector});
      $(this).removeClass('active').addClass('active').siblings().removeClass('active all');
      return false;
    });
  });
